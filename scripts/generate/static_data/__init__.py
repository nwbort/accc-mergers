...
Splits what used to live in ``scripts/generate/generate_static_data.py`` into focused
modules:
...
The orchestrator (``scripts/generate/generate_static_data.py``) stitches these together
