...
Usage
-----
  python -m scripts.generate.generate_similar_mergers           # incremental (skip already-computed)
  python -m scripts.generate.generate_similar_mergers --all     # full recompute
  python -m scripts.generate.generate_similar_mergers --merger-id MN-01016
"""
...
from scripts.detect.party_matching import normalise_name as _normalise_name
...
def _save_output(path: Path, similar: dict) -> None:
    payload = {
        "_note": (
            "Auto-generated by scripts/generate/generate_similar_mergers.py. "
