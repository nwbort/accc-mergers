...
Usage
-----
  python -m scripts.detect.detect_related_mergers [--threshold 0.70] [--summary]
  python -m scripts.detect.detect_related_mergers --apply-suggestions --pr-markdown pr_body.md
...
from scripts.date_utils import parse_iso_datetime as parse_date
