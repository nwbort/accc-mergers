/**
 * Chart colour palette shared by Analysis and Dashboard.
 *
 * CHART_PALETTE holds the named brand colours (plus rgba "Light" variants)
 * used to build chart.js datasets on Analysis/Dashboard.
 */
...
export const DETERMINATION_COLORS = {
  ...
  [MERGER_STATUS.REFERRED_TO_PHASE_2]: CHART_PALETTE.accent,
