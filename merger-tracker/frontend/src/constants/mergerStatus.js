...
export const DIGEST_COLOR_CLASSES = {
  ...
  [DIGEST_COLOR_KEYS.CEASED]: {
    ...
    emptyText: 'text-ceased/70',
    text: 'text-ceased',
    hoverText: 'hover:text-ceased-dark',
  ...
  [DIGEST_COLOR_KEYS.TRIBUNAL_APPEAL]: {
    ...
    emptyText: 'text-tribunal-appeal/70',
    text: 'text-tribunal-appeal',
    hoverText: 'hover:text-tribunal-appeal-dark',
    ...
    labelText: 'text-tribunal-appeal-dark/80',
  },
