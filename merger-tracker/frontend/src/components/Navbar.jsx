        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center gap-1">
            ...
            >
              ...
              {mobileMenuOpen ? (
                <HiXMark className="block h-5 w-5" aria-hidden="true" />
              ) : (
                <HiBars3 className="block h-5 w-5" aria-hidden="true" />
              )}
            </button>
          </div>
        </div>
        ...
        <div id="mobile-menu" className="sm:hidden border-t border-gray-100 bg-white/95 backdrop-blur-lg">
          <div className="px-3 pt-3 pb-1">
            <div className="flex items-center gap-2 bg-gray-100/80 border border-gray-200 rounded-lg px-3 py-2">
              <HiMagnifyingGlass className="h-4 w-4 text-gray-400 shrink-0" aria-hidden="true" />
              <input
