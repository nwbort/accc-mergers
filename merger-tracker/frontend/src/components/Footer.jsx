  ...
  return (
    <footer className="border-t border-gray-200/60 mt-auto bg-white/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="text-center text-xs text-gray-500 leading-relaxed space-y-2">
          <div>
          ...
          <div>
            For enquiries or feedback, please contact <span className="font-semibold text-gray-600">nick@mergers.fyi</span>
          </div>
        </div>
      </div>
    </footer>
