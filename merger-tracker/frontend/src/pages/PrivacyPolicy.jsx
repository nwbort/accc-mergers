    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Last updated: 18 May 2026</p>
        </div>

        {/* 1. Introduction */}
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
        ...
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
          ...
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-3">Information you provide:</p>
        ...
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
          ...
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-3">We use your email address solely to:</p>
          <ul className="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-1 mb-4">
            <li>send you the mergers.fyi weekly digest; and</li>
            <li>manage and maintain our email subscriber list.</li>
          </ul>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-3">We do not use your information for:</p>
        ...
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">4. Email Delivery and Third-Party Services</h2>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-4">
            We use Resend to store email addresses and deliver our email digest.
          </p>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-3">This means:</p>
          <ul className="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-1 mb-4">
        ...
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">5. Data Storage and Security</h2>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-4">
        ...
        {/* 6. Unsubscribing */}
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">6. Unsubscribing</h2>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-3">You can unsubscribe at any time by:</p>
          <ul className="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-1 mb-4">
        ...
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">7. Cookies and Analytics</h2>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-3">We do not use cookies to track individual users. You browser
        ...
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">8. Access and Correction</h2>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
            If you would like to access, update, or delete your email address, you can contact us at{' '}
            <a
              href="mailto:help@mergers.fyi"
              className="text-primary dark:text-accent-light hover:text-primary-dark dark:hover:text-accent-light font-medium hover:underline transition-colors"
            >
              help@mergers.fyi
            </a>
            .
        ...
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">9. Changes to This Policy</h2>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
        ...
        {/* 10. Contact */}
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-card p-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">10. Contact</h2>
          <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
