...
│                         #   Tribunal scraping will maintain it automatically in future.
...
| `scrape-tribunal.yml` | Manual | Scrape Australian Competition Tribunal matter pages into `tribunal_appeals.json` and commit |
